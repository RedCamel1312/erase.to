<?php
// bin/cleanup.php
// Routine for garbage collection of expired or corrupt messages.
// Single-use messages are deleted immediately on consume (see consume-handler.php).
// This script handles expiry-based cleanup. Run every minute via cron.
